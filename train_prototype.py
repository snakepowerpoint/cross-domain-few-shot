...
def main(args):
    ...
    # feature extractor
    init_lr = args.lr
    model = PrototypeNet(n_way, n_shot, n_query, backbone='conv4', learning_rate=init_lr, is_training=is_training)
    ...
    model_test = PrototypeNet(n_way, n_shot, n_query, backbone='conv4', learning_rate=init_lr, is_training=is_training)
